...
> Åbn denne side på [https://superdetective.github.io/robot/](https://superdetective.github.io/robot/)
...
* søg efter **https://github.com/superdetective/robot**, og importer

## Rediger dette projekt ![Byggestatus-badge](https://github.com/superdetective/robot/workflows/MakeCode/badge.svg)

Sådan redigerer du dette lager i MakeCode.

* åbn [https://makecode.microbit.org/](https://makecode.microbit.org/)
* klik på **Importer**, og klik derefter på **Import-URL-adresse**
* indsæt **https://github.com/superdetective/robot**, og klik på Importer
...
![En genereret visning af blokkene](https://github.com/superdetective/robot/raw/master/.github/makecode/blocks.png)
